    ...
    def save(self):
        ...
        for estado in self._saved_page_states:
            ...
            if self._pageNumber != 1:
                ...
                self.drawString(485, 30, "Página %d de %d" % (self._pageNumber, total_paginas))
...
doc = SimpleDocTemplate("pdfs/laudo-007.pdf", **doc_config)
...
doc.build(story, onFirstPage=capa, onLaterPages=cabecalho, canvasmaker=Paginacao)
